...
# File based database ( connects if exits or creates a new one if it does not exists ) 
conn = mysql.connector.connect ( user='akki', password='abc', host='localhost')
...
conn = mysql.connector.connect(user='akkipy', password='12345678',
                              host='db4free.net', database = 'dbaakriti')
#, database = 'forsk_test'
